...
export default function Button({
  ...
  const variants = {
    ...
    secondary: 'bg-background-secondary hover:bg-background-tertiary text-foreground border border-border focus:ring-accent',
    outline: 'border-2 border-accent text-accent hover:bg-accent hover:text-white focus:ring-accent',
    ghost: 'text-foreground-secondary hover:text-accent hover:bg-background-secondary focus:ring-accent',
